...
public class DrawingFrame extends JFrame {
	...
	private MouseAdapter mouseAdapterCalculateArea;
	private MouseAdapter mouseAdapterSaveState;
	private MouseAdapter mouseAdapterGetFirstState;
	...
	public DrawingFrame() {
		...
		tglBtnDrawTriangle = new JToggleButton(new ImageIcon(DrawingFrame.class.getResource("/icons/triangle.png")));
		tglBtnDrawTriangle.setFont(new Font("Dotum", Font.BOLD, 12));
		tglBtnDrawTriangle.setText("Triangle");
		buttonsGroup.add(tglBtnDrawTriangle);
		tglBtnDrawTriangle.setCursor(toolkit.createCustomCursor(image1 , new java.awt.Point(tglBtnDrawTriangle.getX(), tglBtnDrawTriangle.getY()), "img"));
		buttonsPanelForDrawing.add(tglBtnDrawTriangle);
		...
		btnSaveState = new JButton(new ImageIcon(DrawingFrame.class.getResource("/icons/update.png")));
		btnSaveState.setText("Save State");
		btnSaveState.setEnabled(false);
		buttonsGroup.add(btnSaveState);
		btnSaveState.setCursor(toolkit.createCustomCursor(image1 , new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
		buttonsPanel.add(btnSaveState);
		
		btnGetFirstState = new JButton(new ImageIcon(DrawingFrame.class.getResource("/icons/update.png")));
		btnGetFirstState.setText("First State");
		btnGetFirstState.setEnabled(false);
		buttonsGroup.add(btnGetFirstState);
		btnGetFirstState.setCursor(toolkit.createCustomCursor(image1 , new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
		buttonsPanel.add(btnGetFirstState);
		...
		mouseAdapterSaveState = new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent click) {
				controller.btnSaveStateClicked();
			}
		};
		
		mouseAdapterGetFirstState = new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent click) {
				controller.btnGetFirstStateClicked();
			}
		};
		...
		view.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent click) {
				...
				else if (tglBtnDrawTriangle.isSelected()) controller.btnAddTriangleClicked(click);
	...
	public JButton getBtnSaveState() {
		return btnSaveState;
	}
	
	public JButton getBtnGetFirstState() {
		return btnGetFirstState;
	}
	...
	public MouseAdapter getMouseAdapterCalculateArea() {
		return mouseAdapterCalculateArea;
	}
	
	public MouseAdapter getMouseAdapterSaveState() {
		return mouseAdapterSaveState;
	}

	public MouseAdapter getMouseAdapterGetFirstState() {
		return mouseAdapterGetFirstState;
	}
	...
	public JToggleButton getTglBtnDrawTriangle() {
		return tglBtnDrawTriangle;
	}
