	...
	public void propertyChange(PropertyChangeEvent evt) {
		switch(evt.getPropertyName()) {
			...
			case "update/move turn on": 
				...
				addListener(frame.getBtnSaveState(), frame.getMouseAdapterSaveState());
				addListener(frame.getBtnGetFirstState(), frame.getMouseAdapterGetFirstState());
				break;
			case "redo turn off": 
			...
			case "draw is empty":
				...
				frame.getTglBtnDrawTriangle().setEnabled(true);
			...
			case "serialized draw opened":
				...
				frame.getTglBtnDrawTriangle().setEnabled(false);
