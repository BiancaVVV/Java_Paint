...
public class FileLog implements FileHandler {
	 ...
	 */
	public Shape parseShape(String shape, String shapeParameters) {
		...
		else if (shape.equals("Triangle")) return parseTriangle(shapeParameters);
	 ...
	 */
	public Circle parseCircle(String string) {
	 ...
	 */
	public Square parseSquare(String string) {
	...
	public Triangle parseTriangle(String string) {
		...
		int height = Integer.parseInt(triangleParts[2].split("=")[1]);
		int width = Integer.parseInt(triangleParts[3].split("=")[1]);
	 ...
	 */
	public Rectangle parseRectangle(String string) {
	 ...
	 */
	public Line parseLine(String string) {
